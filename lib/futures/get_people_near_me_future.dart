...
Future<List<Person>> getPeopleNearMe(
    {int pageNum = 1, int pageSize = 20, String distance = '2000'}) async {
  ...
  final response = await http.get(
    Uri.parse(
        '${API_URL}user/people?longitude=${position.longitude.toString()}&latitude=${position.latitude.toString()}&pageIndex=${pageNum.toString()}&pageSize=${pageSize.toString()}&distanceRange=$distance&groupToRow=false&rowItemCount=0'),
